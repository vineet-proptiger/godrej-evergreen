  ...
  <section id="developer" className="py-10 sm:py-14 bg-[var(--color-bg-muted)] border-b border-gray-100">
    <div className="container mx-auto px-4 md:px-8">
      ...
      <div className="text-center mb-10" data-aos="fade-up">
        ...
        }}>Godrej Properties — Developer Profile</span>
        <h2 style={{
        ...
        <div style={{
          ...
          <div style={{ padding: '24px 28px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <p style={{ color: '#555', fontFamily: F_SANS, lineHeight: 1.85, fontSize: '14px', margin: '0 0 14px' }}>
              Established in 1990, Godrej Properties is the first real estate company in India to have ISO certification. The company is currently developing landmark projects in 15+ cities across India, covering over 21.7 million square meters. Godrej Properties is known to bring innovation and excellence to the real estate industry — and Godrej Evergreen Square is a proud reflection of that legacy in Hinjawadi Phase 3, Pune.</p>


            {/* Stats */}
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px', marginBottom: '22px' }}>
              {[
                { value: '1990', label: 'Est. — Godrej Properties' },
                { value: '15+', label: 'Cities Across India' },
                { value: '21.7M', label: 'Sq.m Under Development' },
              ].map((stat, i) => (
                <div key={i} style={{
