  ...
  <footer style={{ background: 'var(--color-dark)', color: '#fff' }}>
    ...
    <div style={{ maxWidth: '860px', margin: '0 auto', padding: '56px 24px 32px', textAlign: 'center' }}>
      ...
      <p style={{ fontSize: '13px', color: 'var(--color-gold)', fontFamily: F_JOST, fontWeight: '700', letterSpacing: '1.5px', textTransform: 'uppercase', marginBottom: '12px' }}>
        New Launch — Hinjawadi Phase 3, Pune. By Godrej Properties.
      </p>
      ...
      <p style={{ fontSize: '15px', color: '#bbb', fontFamily: F_SANS, lineHeight: 1.8, marginBottom: '32px', textAlign: 'justify' }}
        ...
        Godrej Evergreen Square is a premium residential development by Godrej Properties, located in Hinjawadi Phase 3 — Pune's most prominent IT corridor. Offering thoughtfully designed 2 &amp; 3 BHK homes with world-class amenities, lush green landscapes, and seamless connectivity to major tech parks including Infosys, Wipro &amp; Cognizant. With possession expected in October 2030 and prices starting at ₹89.99 Lakh*, this is a rare opportunity to own a quality home backed by the 125+ year legacy of the Godrej brand.
      </p>
    ...
    <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-between gap-4 py-4 px-6 border-t border-[#222] text-center sm:text-left max-w-[1200px] mx-auto">
      <p style={{ fontSize: '13px', color: '#888', fontFamily: F_SANS }}>
        &copy; 2026 Godrej Evergreen Square. All rights reserved.
      </p>
