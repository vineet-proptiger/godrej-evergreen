...
const highlights = [
  {
    text: 'Walkable to Hinjawadi IT Park Phase 3',
    icon: <Trees {...highlightIconProps} />,
  },
  {
    text: 'Premium Clubhouse & Social Spaces',
    icon: <Trophy {...highlightIconProps} />,
  },
  {
    text: 'Lush Green Landscape & Garden Walks',
    icon: <Trees {...highlightIconProps} />,
  },
  {
    text: 'Swimming Pool & Aquatic Zone',
    icon: <Waves {...highlightIconProps} />,
  },
  {
    text: 'Modern Gymnasium & Wellness Centre',
    icon: <Dumbbell {...highlightIconProps} />,
  },
  {
    text: "Dedicated Kids' Play & Activity Zone",
    icon: <HeartPulse {...highlightIconProps} />,
  },
  {
    text: 'Smart Home Features & 24×7 Security',
    icon: <Laptop {...highlightIconProps} />,
  },
  {
    text: 'Sustainable & Eco-Friendly Design',
  ...
  <section id="highlights" style={{
    ...
    <div className="container mx-auto px-4 md:px-8">
      ...
      <div style={{ textAlign: 'center', marginBottom: '40px' }} data-aos="fade-up">
        ...
        }}>Hinjawadi Phase 3, Pune — Project Excellence</span>
        <h2 style={{
          fontFamily: F_JOST, fontWeight: '800', fontSize: '26px',
          color: '#111827', margin: 0, letterSpacing: '-0.01em',
        }}>
          Highlights Gallery:{' '}
          <span style={{ color: 'var(--color-gold)' }}>Godrej Evergreen Square</span>
        </h2>
