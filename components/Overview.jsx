...
const MORE_TEXT = ` The "Evergreen" in its name is not just a promise — it is a lived reality, where lush greenery, curated garden walks, and a forest canopy create a sanctuary amidst Pune's busiest IT corridor. Offering premium 2 & 3 BHK homes with world-class amenities, a premium clubhouse, swimming pool, and dedicated recreation zones. With possession expected in October 2030 and prices starting at ₹89.99 Lakh*, backed by Godrej Properties — established in 1990, India's first ISO-certified real estate developer now developing across 15+ cities covering 21.7 million square meters — this is where modern living meets everyday ease.`

const OPEN_VIEWS = [
  { dir: '1m', label: 'Hinjawadi IT Park', sub: 'Walking Distance' },
  { dir: '3m', label: 'Wipro Campus', sub: '3 Mins Away' },
  { dir: '5m', label: 'Infosys BPO', sub: '5 Mins Away' },
  { dir: '8m', label: 'Xion Mall', sub: '8 Mins Away' },
  { dir: '35m', label: 'Pune Airport', sub: '35 Mins Away' },
]
    ...
    <section id="overview" className="!pt-1 !pb-4 sm:!py-10" style={{
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div style={{ textAlign: 'center', marginBottom: '36px' }} data-aos="fade-up">
          ...
          }}>Hinjawadi Phase 3, Pune — New Launch</span>
          <h2 style={{
            fontFamily: F_JOST, fontWeight: '800', fontSize: '26px',
            color: '#111827', margin: 0, letterSpacing: '-0.01em',
          }}>
            Godrej Evergreen Square <span style={{ color: 'var(--color-gold)' }}>Overview</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
          ...
          <div data-aos="fade-right" style={{ display: 'flex' }}>
            <div style={{
              ...
              <Image src={overviewImage} alt="Godrej Evergreen Square" fill className="object-cover"
